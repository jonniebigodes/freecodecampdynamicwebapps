...
class FccDynButton extends Component{
     /**
    ...
    render(){
        ...
        return(
            <div onMouseEnter={this.handleOnMouseEnter} onMouseLeave={this.handleOnMouseLeave} className="buttonApp">
                {showButtonMessage?this.renderButtonInfo():this.renderButtonNormal()}
            </div>
        );
    }
}
FccDynButton.propTypes={
